...
public abstract class AbstractPackagerMojo extends AbstractDependencyFilterMojo {
     ...
     *
     * @return {@code null}, indicating a layout type will be chosen based on the original archive type
     */
    ...
    /**
     * Return the layout factory that will be used to determine the {@link LayoutType} if no explicit layout is set.
     *
    ...
    /**
     * Return the source {@link Artifact} to repackage. If a classifier is specified and an artifact with that classifier exists, it is used. Otherwise, the
     * main artifact is used.
     *
