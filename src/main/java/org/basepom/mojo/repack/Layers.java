...
public class Layers {
    ...
    /**
     * The location of the layers configuration file. If no file is provided, a default configuration is used with four layers: {@code application}, {@code
     * resources}, {@code snapshot-dependencies} and {@code dependencies}.
     *
